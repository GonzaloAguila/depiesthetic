...
export const locations: Location[] = [Location.RAMOS, Location.BELGRANO, Location.CABALLITO, Location.PALERMO];
...
export const MujerCaba = [
    ...
    },
    {
        ...
        items: [
            { label: 'Cuerpo completo', value: 'CCP', price: 10500 },
        ],
    },
];
...
export const HombreCaba = [
    ...
    },
    {
        label: 'Cuerpo completo',
        items: [
            { label: 'Cuerpo completo', value: 'CCP', price: 105000 },
        ],
    },
];
